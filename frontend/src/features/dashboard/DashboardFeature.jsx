  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500">Pharmacy Overview</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          <h2 className="mb-5 text-xl font-semibold">Monthly Sales</h2>
        ...
        <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          <h2 className="mb-5 text-xl font-semibold">Monthly Purchases</h2>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          <div className="mb-5 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500">Last 10 Sales</span>
          </div>
        ...
        <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          <div className="mb-5 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500">Last 10 Purchases</span>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          <div className="mb-5 flex items-center justify-between">
            <h2 className="text-xl font-semibold">Top Medicines</h2>

            <span className="text-sm text-gray-500">Best Selling</span>
          </div>
        ...
        <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          <div className="mb-5 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500">Highest Purchases</span>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
        <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          <div className="mb-5 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-500">Needs Refill</span>
          </div>
        ...
        <Card className="transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          <div className="mb-5 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-semibold">Expiring Batches</h2>
            </div>
